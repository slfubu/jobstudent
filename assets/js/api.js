    ...
    try {
      const response = await fetch(getApiUrl(), {
        ...
        body: JSON.stringify({
          ...
          // Authentication token is sent separately from function arguments.
          // Api.gs validates this token before routing protected actions.
          authToken: sessionStorage.getItem('sessionToken') || ''
        }),
      ...
      if (!payload || payload.ok !== true) {
        ...
        // Clear stale local sessions when the server rejects/expirs the token.
